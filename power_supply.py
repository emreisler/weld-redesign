...
class PowerSupply:
    ...
    def run_cycle(self,ui = None, voltage1 = 0, current1 = 0, time1 = 0, voltage2 = 0,
        ...
        try:
            if ui :
                ...
                ui.run_cycle_button.setStyleSheet("color : rgb(78, 154, 6)")
            ...
            if ui:
                ...
                ui.run_cycle_button.setStyleSheet("color : white")
            self.cycle_continue = False    
    ...
    def stop(self,ui = None,simu_mode = False):
        ...
        if not simu_mode:
            ...
            self.cycle_continue = False
        if ui:
            ui.cycle_info_label.setText("Cycle interrupted by STOP button")
